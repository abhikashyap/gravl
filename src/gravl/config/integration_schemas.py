...
SCHEMAS: dict[str, IntegrationSchema] = {
    ...
    "eshopbox": IntegrationSchema(
        ...
        docs_url="https://help.eshopbox.com/portal/en/kb",
        fields=(
            Field("customer_id", "Eshopbox Customer ID / Org ID",
                  help="the WMS tenant identifier"),
            Field("api_key", "API key", secret=True, required=False,
                  help="for REST pulls (if exposed)"),
            Field("webhook_secret", "Webhook secret", secret=True, required=False,
                  help="token Eshopbox signs push payloads with"),
        ),
    ),
